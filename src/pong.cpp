...
bool pong(RenderWindow &window, Game &game, Audio &audio)
{
    ...
    Paddle e_Player1(Vector2f(25,(window.getPos().h - 100)/2, 20, 100),window.tex[PADDLE_1]);
    Paddle e_Player2(Vector2f(window.getPos().w - 45,(window.getPos().h - 100)/2, 20, 100),window.tex[PADDLE_2]);
    ...
    // Loop
    FPS fps;
    fps.start(); game.reset(e_Ball,e_Player1,e_Player2);
