...
enum texture_id {
    BORDA_MOVE1, BORDA_MOVE2, BORDA_ATIVABOLA, BORDA_VOLTARAOMENU,
    MARKBOX, MARKEDBOX, GRADE, BALL_R, BALL_B, BALL_W, PADDLE_1, PADDLE_2, 
    ALT_RANDOM, ALT_1, ALT_2, ALT_3, ALT_4, ALT_5, ALT_0,
    ALT_R, ALT_L, ALT_I, ALT_III, ALT_V, ALT_X, ALT_C, ALT_INF,
    FIREWORK_1, FIREWORK_2, P2_WIN, P2_LOSE, P1_WIN, P1_LOSE, WALL,
    WALL_RED, WALL_BLUE, POWERBOX_ZAP, POWERBOX_GRAV, POWERBOX_ANTIGRAV,
    POWERBOX_WALL, POWERBOX_INVERT, POWERBOX_BIG, POWERBOX_SMALL,
    ...
    VOLTAR, PLAY, CONTROLS, CONFIG, ADM_MOVEBALL, ADM_SECRETBG, ADM_MOVEBALL2
};
